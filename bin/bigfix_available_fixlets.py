...
import input_module_bigfix_available_fixlets as input_module
...
'''
    ...
    Add your modular input logic to file input_module_bigfix_available_fixlets.py
'''
class ModInputbigfix_available_fixlets(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputbigfix_available_fixlets, self).__init__("ta_bigfix", "bigfix_available_fixlets", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputbigfix_available_fixlets, self).get_scheme()
        scheme.title = ("BigFix Available Fixlets")
...
if __name__ == "__main__":
    exitcode = ModInputbigfix_available_fixlets().run(sys.argv)
    sys.exit(exitcode)

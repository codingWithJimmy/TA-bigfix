...
import input_module_bigfix_clients as input_module
...
'''
    ...
    Add your modular input logic to file input_module_bigfix_clients.py
'''
class ModInputbigfix_clients(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputbigfix_clients, self).__init__("ta_bigfix", "bigfix_clients", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputbigfix_clients, self).get_scheme()
        scheme.title = ("BigFix Clients")
...
if __name__ == "__main__":
    exitcode = ModInputbigfix_clients().run(sys.argv)
    sys.exit(exitcode)

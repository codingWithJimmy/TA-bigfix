...
def collect_events(helper, ew):
    ...
    query='(%22nt_host%3D%22+%26+item+0+of+it%2C+%22status%3D%22+%26+item+1+of+it%2C+%22issuer%3D%22+%26+item+2+of+it%2C+%22issue_time%3D%22+%26+item+3+of+it%2C+%22end_time%3D%22+%26+item+4+of+it%2C+%22start_time%3D%22+%26+item+5+of+it%2C+%22action_id%3D%22+%26+item+6+of+it%2C+%22action_name%3D%22+%26+item+7+of+it%2C+%22reapply%3D%22+%26+item+8+of+it%2C+%22restart_required%3D%22+%26+item+9+of+it%2C+%22stopper%3D%22+%26+item+10+of+it%2C+%22time_stopped%3D%22+%26+item+11+of+it)+of+(names+of+computers+of+item+0+of+it+as+string%2C+status+of+item+0+of+it+as+string%2C+name+of+issuer+of+item+1+of+it+as+string%2C+time+issued+of+item+1+of+it+as+string%2C+(if+(exists+end+date+of+item+1+of+it)+then+end+date+of+item+1+of+it+as+string+%26+%22+%22+%26+end+time_of_day+of+item+1+of+it+as+string+else+%22%22)%2C+(if+(exists+start+date+of+item+1+of+it)+then+start+date+of+item+1+of+it+as+string+%26+%22+%22+%26+start+time_of_day+of+item+1+of+it+as+string+else+%22%22)%2C+id+of+item+1+of+it+as+string%2C+(concatenation+%22%252527%22+of+(substrings+separated+by+%22%252522%22+of+name+of+item+1+of+it+as+string))%2C+reapply+flag+of+item+1+of+it+as+string%2C+restart+flag+of+item+1+of+it+as+string%2C+(if+(exists+stopper+of+item+1+of+it)+then+name+of+stopper+of+item+1+of+it+as+string+else+%22%22)%2C+(if+(exists+time+stopped+of+item+1+of+it)+then+time+stopped+of+item+1+of+it+as+string+else+%22%22))+of+(results+of+it%2C+it)+of+(bes+actions)'#.replace("SETS", opt_sets)
